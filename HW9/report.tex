...
\caption{Pendulum-v1 Experiment}
\label{fig:exp1}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{output3.png}
\caption{Q-function plot}
\label{fig:exp1}
\end{figure}
...
\caption{Experiments with varying learning rate and update frequency}
\label{fig:exp1}
\end{figure}
...
\caption{HalfCheetah-v4 Experiment}
\label{fig:exp1}
\end{figure}
